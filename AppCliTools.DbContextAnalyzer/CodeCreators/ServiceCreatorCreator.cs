...
public sealed class ServiceCreatorCreator : CodeCreator
{
    ...
    {
        string dataSeedingProjectName = $"{_par.DbProjectNamespace}DataSeeding.DataSeeding"; //GeoModelDataSeeding
        string newDataSeedingProjectName = $"{_par.DbProjectNamespace}DataSeeding.NewDataSeeding"; //GeoModelNewDataSeeding
        ...
        var block = new CodeBlock(string.Empty, new OneLineComment($"Created by {GetType().Name} at {DateTime.Now}"),
            ...
            new CodeBlock("public sealed class SeedDbServicesCreator : ServicesCreator", string.Empty,
                ...
                new OneLineComment(" ReSharper disable once ConvertToPrimaryConstructor"), new CodeBlock(
                    "public SeedDbServicesCreator(string? logFolder, string? logFileName, string appName, string connectionString) : base(logFolder, logFileName, appName)", //, string excludesRulesParametersFilePath
                    "_connectionString = connectionString"
                    //,
                    //"_excludesRulesParametersFilePath = excludesRulesParametersFilePath"
                ), string.Empty, new CodeBlock("protected override void ConfigureServices(IServiceCollection services)",
