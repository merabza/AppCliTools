...
public sealed class ProjectDataSeedersFactoryCreator : SeederCodeCreatorBase
{
    ...
    {
        var block = new CodeBlock(string.Empty, new OneLineComment($"Created by {nameof(ProjectDataSeedersFactoryCreator)} at {DateTime.Now}"),
    ...
    public void UseEntity(EntityData entityData, bool isCarcassType)
    {
        ...
        var block = new CodeBlock(
            ...
            $"return new {newClassName}({additionalParameters}DataSeedFolder, Repo, UnitOfWork)");
